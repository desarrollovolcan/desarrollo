...
$ARRAYDRECEPCIONPT = $DRECEPCIONPT_ADO->verDrecepcion2($IDOP);
if($ARRAYDRECEPCIONPT){
	$ARRAYDRECEPCIONPTTOTALES = $DRECEPCIONPT_ADO->obtenerTotales2($IDOP);


	$ARRAYRECEPCIONPT = $RECEPCIONPT_ADO->verRecepcion2($ARRAYDRECEPCIONPT[0]['ID_RECEPCION']);
