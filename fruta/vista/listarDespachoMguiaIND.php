...
if (isset($_SESSION['parametro']) && isset($_SESSION['parametro1']) && isset($_SESSION['urlO'])) {
    ...
    $URLO = $_SESSION['urlO'];
    $ARRAYMGUIAIND = $MGUIAIND_ADO->listarMguiaEmpresaPlantaTemporadaDespachoOrigenCBX2($IDP, $EMPRESAS, $PLANTAS, $TEMPORADAS);
}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 col-xs-2">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-block  btn-success" data-toggle="tooltip" title="Volver" name="CANCELAR" value="CANCELAR" Onclick="irPagina('listarDespachoind.php'); ">
                                    ...
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12">
                                        <div class="table-responsive">
                                            <table id="modulo" class="table-hover " style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <?php foreach ($ARRAYMGUIAIND as $r) : ?>
                                                        <?php
